---
{"dg-publish":true,"permalink":"/10-encounter/information-architecture/","dgPassFrontmatter":true,"noteIcon":"","created":"2025-02-28T15:55:20.486+08:00"}
---

# Information architecture
The structure of a book has a purpose. The title, subtitle, and the genre serve a purpose to help you pigeonhole the book into their categories. It prepare you to read them. The table of content, index, and references tells you a quick breakdown of the book, a quick way to find things, and which giant's shoulder does this book stand on. 
...
## Why obsidian?
It is organise in a graph way. Graph can visualised how the argument and inferences are linked and made up. In a world where there are full of misinformation and disinformation. It is important for us to trace the source of an information to know the validity of that information. AI although can give you the information in quick way but you can't be sure and examine what is within the black box. Graph then is the way to be transparent with the information and enhance the accessibility to assess the information. There are two technologies can be used in maintaining a good information source (1) open linked data and (2) blockchain. 